...
const shadesOfViolet = new Color('violet', 'linear-gradient(-45deg, #DEDDFA, #DAB8F3, #FFD372, #905E96)', 'rgba(0, 0, 0, .9)', 'white', '-webkit-linear-gradient(#b888da, #7148d5, #5c4080)')
